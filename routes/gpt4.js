...
router.get('/gpt4', async (req, res) => {
  try {
    ...
    if (closestMatch) {
      ...
      const apiUrl = `https://hercai.onrender.com/v3/hercai?question=Your an Ai language mode developed by OpenAi called GPT-4. Your designed to understand and generate human-like text base on the input you receive. And answer this question:${encodeURIComponent(userQuestion)}`;
